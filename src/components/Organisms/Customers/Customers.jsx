    ...
    <div className="customers">
      ...
      <div className="customers__more">
        <p>
          ...
          numquam tempora? Dolore officia praesentium numquam veritatis expedita
          iusto eius, explicabo alias, totam neque, voluptas vero cupiditate in?
          Delectus illum velit, libero, fugit rerum deleniti veritatis,
          inventore explicabo minima voluptate ut voluptatum dolor
          necessitatibus architecto magnam porro voluptatem nobis consequatur
          qui.
        </p>
