    ...
    <>
      <div className="container">
        <div className="info">
          ...
          <p>
            Explore AnalytiX&#39;s blog for the latest insights on data-driven
            decision-making for small businesses like supermarkets. Discover how
            our software helps businesses increase membership income and make
            informed decisions. Join our community and stay ahead with AnalytiX!
          </p>
        </div>
